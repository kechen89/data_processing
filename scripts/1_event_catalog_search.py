...
# Time period limits 
#tstart = UTCDateTime("1996-01-01")
#tstart = UTCDateTime("2010-01-01")
tstart = UTCDateTime("2000-01-01")
tend = UTCDateTime("2018-12-31")
#tstart = UTCDateTime("2018-01-01")
#tend = UTCDateTime("2018-01-05")
#tstart = UTCDateTime("2018-05-30")
#tend = UTCDateTime("2018-06-01")
